...
if(!strpos($link,'login.php') && !strpos($link,'login_verification.php') && !strpos($link,'registration.php') && !isset($_SESSION['user_login']) && !strpos($link, 'email_verification.php') && !strpos($link, 'forgotPassword.php'))
{
